# 📄 MODEL CARD: MOD_06_EXIT_TIMING — MOD_06_EXIT_TIMING

> **Version**: 2.0  
> **Layer**: `layer_3_planning`  
> **Lifecycle Status**: `RESEARCH_VALIDATED` (Passed LeakageGuard & Out-of-Time Test)  
> **Audited Date**: 2026-07-29T20:50:58Z  
...
* **Top Drivers**: `spot_price` (53.09%), `trailing_stop_vwap` (46.91%), `atr_14` (0.0%)
